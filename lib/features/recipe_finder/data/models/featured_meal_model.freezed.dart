...
part of 'featured_meal_model.dart';
...
/// @nodoc
mixin _$FeaturedMealModel {

 List<Meal>? get meals;
/// Create a copy of FeaturedMealModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FeaturedMealModelCopyWith<FeaturedMealModel> get copyWith => _$FeaturedMealModelCopyWithImpl<FeaturedMealModel>(this as FeaturedMealModel, _$identity);

  /// Serializes this FeaturedMealModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeaturedMealModel&&const DeepCollectionEquality().equals(other.meals, meals));
}
...
@override
String toString() {
  return 'FeaturedMealModel(meals: $meals)';
}
...
/// @nodoc
abstract mixin class $FeaturedMealModelCopyWith<$Res>  {
  factory $FeaturedMealModelCopyWith(FeaturedMealModel value, $Res Function(FeaturedMealModel) _then) = _$FeaturedMealModelCopyWithImpl;
@useResult
$Res call({
 List<Meal>? meals
});
...
/// @nodoc
class _$FeaturedMealModelCopyWithImpl<$Res>
    implements $FeaturedMealModelCopyWith<$Res> {
  _$FeaturedMealModelCopyWithImpl(this._self, this._then);

  final FeaturedMealModel _self;
  final $Res Function(FeaturedMealModel) _then;
...
/// Adds pattern-matching-related methods to [FeaturedMealModel].
extension FeaturedMealModelPatterns on FeaturedMealModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FeaturedMealModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FeaturedMealModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FeaturedMealModel value)  $default,){
final _that = this;
switch (_that) {
case _FeaturedMealModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FeaturedMealModel value)?  $default,){
final _that = this;
switch (_that) {
case _FeaturedMealModel() when $default != null:
return $default(_that);case _:
...
class _FeaturedMealModel implements FeaturedMealModel {
  const _FeaturedMealModel({final  List<Meal>? meals}): _meals = meals;
  factory _FeaturedMealModel.fromJson(Map<String, dynamic> json) => _$FeaturedMealModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$FeaturedMealModelCopyWith<_FeaturedMealModel> get copyWith => __$FeaturedMealModelCopyWithImpl<_FeaturedMealModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FeaturedMealModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FeaturedMealModel&&const DeepCollectionEquality().equals(other._meals, _meals));
}
...
/// @nodoc
abstract mixin class _$FeaturedMealModelCopyWith<$Res> implements $FeaturedMealModelCopyWith<$Res> {
  factory _$FeaturedMealModelCopyWith(_FeaturedMealModel value, $Res Function(_FeaturedMealModel) _then) = __$FeaturedMealModelCopyWithImpl;
@override @useResult
$Res call({
 List<Meal>? meals
});
...
/// @nodoc
class __$FeaturedMealModelCopyWithImpl<$Res>
    implements _$FeaturedMealModelCopyWith<$Res> {
  __$FeaturedMealModelCopyWithImpl(this._self, this._then);

  final _FeaturedMealModel _self;
  final $Res Function(_FeaturedMealModel) _then;

/// Create a copy of FeaturedMealModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? meals = freezed,}) {
  return _then(_FeaturedMealModel(
